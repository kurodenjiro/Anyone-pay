...
// ORAI bech32 prefix (replacing @oraichain/common import to avoid axios conflicts)
const ORAI = 'orai';
...
async function uncompressedHexPointToBtcAddress(publicKeyHex : any , networkByte : any) {
...
export async function generateAddress({
    ...
    switch (chain) {
        ...
        case 'cosmos':
            ...
            break;
        case 'base':
            // Base is EVM-compatible, use Ethereum address format
            address = uncompressedHexPointToEvmAddress(childPublicKey);
            break;
        default:
            // Default to Ethereum address format for unknown chains
            address = uncompressedHexPointToEvmAddress(childPublicKey);
            break;
    }
    return {
...
export function bech32ToEvm(bech32Address : any) {
